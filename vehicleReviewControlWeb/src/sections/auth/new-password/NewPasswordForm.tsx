...
export default function NewPasswordForm() {
  ...
  const VerifyCodeSchema = Yup.object().shape({
    code1: Yup.string().required('Código é obrigatório'),
    code2: Yup.string().required('Código é obrigatório'),
    code3: Yup.string().required('Código é obrigatório'),
    code4: Yup.string().required('Código é obrigatório'),
    code5: Yup.string().required('Código é obrigatório'),
    code6: Yup.string().required('Código é obrigatório'),
    email: Yup.string().email('O e-mail deve ser um endereço de e-mail válido').required('Email é obrigatório'),
    password: Yup.string()
